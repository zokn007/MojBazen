...
function exportJSON(){download(JSON.stringify({version:"6.0",profile:profile(),measurements:measurements(),logs:get(KEYS.logs,[]),stock:get(KEYS.stock,[]),tasks:tasks(),multitab:multitabData(),diagnostics:get(KEYS.diagnostics,[])},null,2),"MojBazen-v6-0-backup.json","application/json")}
...
function toggleDark(){document.body.classList.add("dark");set(KEYS.dark,true)}
